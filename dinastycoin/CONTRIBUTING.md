...
posted to #dinastycoin-dev on irc.freenode.net).
...
Copyright (c) 2017-2018 Copyright (c) 2014-2019 The Monero Project.
Parts are Copyright (c) 2020-2021 The Dinastycoin team
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Dinastycoin code or Dinastycoin's dependency code or Dinastycoin's potential/future dependency code or research which successfully implements Dinastycoin.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Dinastycoin Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Dinastycoin Maintainer Team.
