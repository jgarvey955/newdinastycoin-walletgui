...
*Setup instructions for a Gitian build of Dinastycoin using Docker.*
...
* a fork of the [gitian.sigs](https://github.com/dinastyoffreedom/gitian.sigs/) repo on your GitHub account.
