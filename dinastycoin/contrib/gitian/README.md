...
*Setup instructions for a Gitian build of Dinastycoin.*

Gitian is the deterministic build process that is used to build the Dinastycoin CLI
...
fork the [gitian.sigs repository](https://github.com/dinastyoffreedom/gitian.sigs) and clone it on your host machine, 
or pass the signed assert file back to your build machine.

```bash
git clone git@github.com:dinastyoffreedom/gitian.sigs.git
...
You can also look in the [gitian.sigs](https://github.com/dinastyoffreedom/gitian.sigs/) repo and / or [dinastycoin.com release checksums](https://web.dinastycoin.com/downloads/hashes.txt) to see if others got the same checksum for the same version tag.  If there is ever a mismatch -- **STOP! Something is wrong**.  Contact others on IRC / github to figure out what is going on.
...
gpg --detach-sign ${VERSION}-android/${GH_USER}/dinastycoin-android-*-build.assert
```
...
[dinastyoffreedom/gitian.sigs](https://github.com/dinastyoffreedom/gitian.sigs/) repository:
...
**Note:** Please ensure your gpg public key is available to check signatures by adding it to the [gitian.sigs/gitian-pubkeys/](https://github.com/dinastyoffreedom/gitian.sigs/tree/master/gitian-pubkeys) directory in a pull request.
